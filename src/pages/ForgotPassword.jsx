...
const styles = {
  ...
  backLink: { display: 'block', textAlign: 'center', color: 'var(--blue-l)', fontSize: 14, fontWeight: 600, textDecoration: 'none' },
  successBox: { background: 'rgba(10,21,48,0.8)', border: '1px solid var(--border)', borderRadius: 16, padding: 24, textAlign: 'center', marginBottom: 18 },
  successIcon: { width: 44, height: 44, borderRadius: '50%', background: 'linear-gradient(135deg, var(--blue), var(--blue-l))', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 14px', fontWeight: 800 },
  successTitle: { fontFamily: 'Syne, sans-serif', fontSize: 20, marginBottom: 8 },
  successText: { color: 'var(--muted)', fontSize: 14, lineHeight: 1.6 },
  btnSecondary: { display: 'block', width: '100%', textAlign: 'center', background: 'transparent', border: '1px solid var(--border)', borderRadius: 10, padding: 14, color: 'var(--white)', fontSize: 14, fontWeight: 600, textDecoration: 'none' },
}